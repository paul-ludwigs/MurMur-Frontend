        ...
        <div className="row my-3">
          <div className="col-sm-12">
            <div className="text-center">
              <h1 className="greeting-font">Hello there, {userName}!</h1>
            </div>
            <div
            ...
            >
              ...
              <div style={{ padding: "0.5rem" }}>
                <p style={{ padding: "0.5rem" }}>
                  ...
                  Cityname you might be interested in and our Database will
                  spool up to deliver the MurMurs you were looking for! The
                  result page comes with a bunch of filters for you to click and
                  better navigate, you must not worry about those for now!
                </p>
                <div
                      ...
                      >
                        ...
                        <div className="carousel-item">
                          ...
                          >
                            ...
                            <p>
                              Tokyo, the capital of Japan is among our
                              communitys favourites!
                            </p>
                        ...
                        <div className="carousel-item">
                          ...
                          >
                            ...
                            <p>What about... Rome!</p>
                            <p>
                              Bella Italia... Exceptional Food and a city rich
                              in History!
                            </p>
                            <p>648 MurMurs for you to explore!</p>
                          </div>
                        </div>
                      </div>
                      <button
