...
setImage({uploadImg: event.target.files[0]})
console.log(image)
}
  ...
  const handleSubmit = function (event) {
    ...
    if (postArray.length == 0 || !cityName || !tip) {
      ...
      const newMurmur = {
        ...
        date: today,
        tags: postArray,
        uploadedPicture: formData,
      };
      axios
        .post(`${api}/Murmur`, newMurmur)
      ...
      function statusCheck(res) {
        if (res.status === 201) {
          ...
          toast(
            "Oh no. Something went wrong, we could not create your MurMur!"
          );
        }
      }
    }
      ...
      <div className="container mx-auto">
        <div className="row d-flex justify-content-center">
          <div className="col transparent-bg my-2 mx-3">
            <h5 className="mt-3">
              Go on then, we're super eager to learn what you've got to share!
            </h5>
            <br />
