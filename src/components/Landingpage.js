    ...
    <>
      ...
      <div className="container mx-auto text-center mt-3">
        <p className="card-text mt-" style={{padding:"0.5em"}}>
          ...
          and want to discover more? No problem! Download our app and learn
          useful tips as well as warnings from other travelers. But you are
          also welcome to share your experiences with others.
        </p>
        ...
        <div className="card-body">
          <p className="card-text" style={{padding:"2rem"}}>
            Let's login to create a travel tip or planning your
            trip!
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} id="loginformular">
          ...
          <button type="submit" className="button btn btn-info mb-3 mt-5">
            Sign-In
          </button>
        </form>
